...
import com.example.ui.screens.analyzer.UsbSessionReportsScreen
...
fun MainNavGraph(
    ...
    NavHost(
        ...
        composable(Screen.SessionReports.route) {
            UsbSessionReportsScreen(onBack = { navController.popBackStack() })
        }
    }
}
